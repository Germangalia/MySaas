...
(function() {
    ...
    try {
        ...
        var createPDF = function(update_preview) {
            ...
            // form data
            var flyer_title = $('#invoice-title').val(),
                flyer_title_size = $('#invoice-title-size').val(),
                flyer_title_color = $('#invoice-title-color').val(),
                flyer_description = $('#invoice-description').val(),
                flyer_price = $('#invoice-price').val(),
                flyer_price_currency = $('#invoice-price-currency').val(),
                flyer_price_color = $('#invoice-price-color').val();
