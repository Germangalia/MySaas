...
@section('custom_scripts')
    ...
    <script type="text/javascript">
        ...
        /**
         * Created by ggalia84 on 5/04/16.
         */
        ...
        (function() {
            ...
            var agency_logo = {
                    ...
                    agency_name = 'Create Invoice',
                    agency_site_url = 'www.createinvoice.com',
            ...
            try {
                ...
                $('#invoice-image').change(function() {
                    ...
                    var user_file = invoice_img[0].files[0];
                ...
                var createPDF = function(update_preview) {
                    ...
                    // form data
                    var invoice_title = $('#invoice-title').val(),
                            invoice_title_size = $('#invoice-title-size').val(),
                            invoice_title_color = $('#invoice-title-color').val(),
                            invoice_description = $('#invoice-description').val(),
                            invoice_price = $('#invoice-price').val(),
                            invoice_price_currency = $('#invoice-price-currency').val(),
                            invoice_price_color = $('#invoice-price-color').val();
                    ...
                    pdf.setProperties({
                        ...
                        subject: footer,
                        author: 'me',
                        creator: 'Invoice Builder & jsPDF'
                    });

                    if(img_data){
                        pdf.addImage(img_data.src, 'PNG', 100, 100, 300, 200);
                    }

//
//                    // !logo
//                    var logo_sizes = imgSizes(agency_logo.w, agency_logo.h, 60);
//                    pdf.addImage(img_data.src, 'PNG', logo_sizes.centered_x, _y, logo_sizes.w, logo_sizes.h);
//
//                    // fonts initializing
...
//
//                    // !main title
//                    color_array = hex2rgb(invoice_title_color);
//                    pdf.setTextColor(color_array.red, color_array.green, color_array.blue);
//
//                    pdf.setFontSize(invoice_title_size);
//
//                    lineHeight = px2mm(pdf.getLineHeight(invoice_title));
//
//                    _y += (logo_sizes.h + vspace + lineHeight);
//
//                    pdf.textAlign(invoice_title, {
//                        align: "center"
//                    }, 0, _y);
//
//                    _y += vspace;
...
//                    color_array = hex2rgb(invoice_price_color);
...
//                    pdf.setFontType("bold");
//
//                    _string = invoice_price_currency + parseInt(invoice_price); // decimals are removed
//
//                    lineHeight = px2mm(pdf.getLineHeight(_string));
...
//
//                        var description_lines = pdf.splitTextToSize(invoice_description, lineWidth);
...
//                    } else {
//                        pdf.save('invoice ' + invoice_title + '.pdf');
//                    }
            ...
            <div class="row">
                <div class="col-sm-7">
                    <div class="form-group">
                        ...
                        <input required class="form-control" id="invoice-title" placeholder="Main title" value="Really incredible!!" maxlength="255" type="text" tabindex="2">
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
